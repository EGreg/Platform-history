...
<head>
	...
	<link rel="icon" sizes="76x76" href="<?php echo Q_Html::themedUrl('img/icon/76.png') ?>" />
	<link rel="icon" sizes="120x120" href="<?php echo Q_Html::themedUrl('img/icon/120.png') ?>" />
	<link rel="icon" sizes="152x152" href="<?php echo Q_Html::themedUrl('img/icon/152.png') ?>" />
	<link rel="icon" sizes="180x180" href="<?php echo Q_Html::themedUrl('img/icon/180.png') ?>" />
