 ...
 * Instead, change the Awards_HostnameSession.php file.
 *
 * @module Awards
 */
/**
 * Base class representing 'HostnameSession' rows in the 'Awards' database
 * @class Base_Awards_HostnameSession
 * @extends Db_Row
 *
 * @property {string} $hostname
 * @property {string} $sessionId
 */
abstract class Base_Awards_HostnameSession extends Db_Row
{
	/**
	 * @property $hostname
	 * @type {string}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Awards', 'indexes', 'HostnameSession', false)) {
	...
	static function select($fields, $alias = null)
	{
		...
		$q->className = 'Awards_HostnameSession';
		return $q;
	}
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Awards_HostnameSession'))
		);
	}
