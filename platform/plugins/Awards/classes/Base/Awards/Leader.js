 ...
 * Instead, change the Awards/Leader.js file.
 *
 * @module Awards
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Awards', 'indexes', 'Leader'], false)) {
...
Base.prototype.beforeSet_points = function (value) {
		...
		if (value < -32768 || value > 32767)
			throw new Error("Out-of-range value '"+value+"' being assigned to "+this.table()+".points");
		return value;
};
