 ...
 * Instead, change the Awards_Share.php file.
 *
 * @module Awards
 */
/**
 * Base class representing 'Share' rows in the 'Awards' database
 * @class Base_Awards_Share
 * @extends Db_Row
 *
 ...
 */
abstract class Base_Awards_Share extends Db_Row
{
	/**
	 * @property $share_id
	 * @type {string}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Awards', 'indexes', 'Share', false)) {
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Awards_Share'))
		);
	}
