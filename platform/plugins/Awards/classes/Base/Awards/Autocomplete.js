 ...
 * Instead, change the Awards/Autocomplete.js file.
 *
 * @module Awards
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Awards', 'indexes', 'Autocomplete'], false)) {
 ...
 * @type string
 */
Base.prototype.className = "Awards_Autocomplete";
