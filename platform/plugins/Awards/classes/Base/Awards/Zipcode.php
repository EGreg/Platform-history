 ...
 * Instead, change the Awards_Zipcode.php file.
 *
 * @module Awards
 */
/**
 * Base class representing 'Zipcode' rows in the 'Awards' database
 * @class Base_Awards_Zipcode
 * @extends Db_Row
 *
 ...
 */
abstract class Base_Awards_Zipcode extends Db_Row
{
	/**
	...
	{
		if (Q_Config::get('Db', 'connections', 'Awards', 'indexes', 'Zipcode', false)) {
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Awards_Zipcode'))
		);
	}
