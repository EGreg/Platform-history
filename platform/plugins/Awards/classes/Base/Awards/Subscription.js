 ...
 * Instead, change the Awards/Subscription.js file.
 *
 * @module Awards
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Awards', 'indexes', 'Subscription'], false)) {
 ...
 * @type string
 */
Base.prototype.className = "Awards_Subscription";
