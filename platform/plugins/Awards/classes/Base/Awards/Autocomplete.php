 ...
 * Instead, change the Awards_Autocomplete.php file.
 *
 * @module Awards
 */
/**
 * Base class representing 'Autocomplete' rows in the 'Awards' database
 * @class Base_Awards_Autocomplete
 * @extends Db_Row
 *
 ...
 */
abstract class Base_Awards_Autocomplete extends Db_Row
{
	/**
	 * @property $query
	 * @type {string}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Awards', 'indexes', 'Autocomplete', false)) {
	...
	static function select($fields, $alias = null)
	{
		...
		$q->className = 'Awards_Autocomplete';
		return $q;
	}
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Awards_Autocomplete'))
		);
	}
