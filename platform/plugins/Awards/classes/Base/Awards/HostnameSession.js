 ...
 * Instead, change the Awards/HostnameSession.js file.
 *
 * @module Awards
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Awards', 'indexes', 'HostnameSession'], false)) {
 ...
 * @type string
 */
Base.prototype.className = "Awards_HostnameSession";
