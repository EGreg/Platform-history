 ...
 * Instead, change the Awards_Session.php file.
 *
 * @module Awards
 */
/**
 * Base class representing 'Session' rows in the 'Awards' database
 * @class Base_Awards_Session
 * @extends Db_Row
 *
 * @property {string} $id
 * @property {integer} $insertedTime
 */
abstract class Base_Awards_Session extends Db_Row
{
	/**
	 * @property $id
	 * @type {string}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Awards', 'indexes', 'Session', false)) {
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Awards_Session'))
		);
	}
