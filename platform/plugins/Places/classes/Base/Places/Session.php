 ...
 * Instead, change the Places_Session.php file.
 *
 * @module Places
 */
/**
 * Base class representing 'Session' rows in the 'Places' database
 * @class Base_Places_Session
 * @extends Db_Row
 *
 * @property {string} $id
 * @property {integer} $insertedTime
 */
abstract class Base_Places_Session extends Db_Row
{
	/**
	 * @property $id
	 * @type {string}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Places', 'indexes', 'Session', false)) {
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Places_Session'))
		);
	}
