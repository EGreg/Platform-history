 ...
 * Instead, change the Places/HostnameSession.js file.
 *
 * @module Places
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Places', 'indexes', 'HostnameSession'], false)) {
 ...
 * @type string
 */
Base.prototype.className = "Places_HostnameSession";
