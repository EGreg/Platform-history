 ...
 * Instead, change the Places/Publisher.js file.
 *
 * @module Places
 */
...
/**
 * Base class representing 'Publisher' rows in the 'Places' database
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Places', 'indexes', 'Publisher'], false)) {
 ...
 * @type string
 */
Base.prototype.className = "Places_Publisher";
