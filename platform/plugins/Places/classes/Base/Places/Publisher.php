 ...
 * Instead, change the Places_Publisher.php file.
 *
 * @module Places
 */
/**
 * Base class representing 'Publisher' rows in the 'Places' database
 * @class Base_Places_Publisher
 * @extends Db_Row
 *
 * @property {integer} $id
 ...
 */
abstract class Base_Places_Publisher extends Db_Row
{
	/**
	 * @property $id
	 * @type {integer}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Places', 'indexes', 'Publisher', false)) {
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Places_Publisher'))
		);
	}
