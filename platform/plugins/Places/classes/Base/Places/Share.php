 ...
 * Instead, change the Places_Share.php file.
 *
 * @module Places
 */
/**
 * Base class representing 'Share' rows in the 'Places' database
 * @class Base_Places_Share
 * @extends Db_Row
 *
 ...
 */
abstract class Base_Places_Share extends Db_Row
{
	/**
	 * @property $share_id
	 * @type {string}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Places', 'indexes', 'Share', false)) {
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Places_Share'))
		);
	}
