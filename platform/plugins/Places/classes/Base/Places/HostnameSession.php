 ...
 * Instead, change the Places_HostnameSession.php file.
 *
 * @module Places
 */
/**
 * Base class representing 'HostnameSession' rows in the 'Places' database
 * @class Base_Places_HostnameSession
 * @extends Db_Row
 *
 * @property {string} $hostname
 * @property {string} $sessionId
 */
abstract class Base_Places_HostnameSession extends Db_Row
{
	/**
	 * @property $hostname
	 * @type {string}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Places', 'indexes', 'HostnameSession', false)) {
	...
	static function select($fields, $alias = null)
	{
		...
		$q->className = 'Places_HostnameSession';
		return $q;
	}
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Places_HostnameSession'))
		);
	}
