 ...
 * Instead, change the Places_Visit.php file.
 *
 * @module Places
 */
/**
 * Base class representing 'Visit' rows in the 'Places' database
 * @class Base_Places_Visit
 * @extends Db_Row
 *
 * @property {string} $id
 ...
 */
abstract class Base_Places_Visit extends Db_Row
{
	/**
	 * @property $id
	 * @type {string}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Places', 'indexes', 'Visit', false)) {
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Places_Visit'))
		);
	}
