 ...
 * Instead, change the Places_Domain.php file.
 *
 * @module Places
 */
/**
 * Base class representing 'Domain' rows in the 'Places' database
 * @class Base_Places_Domain
 * @extends Db_Row
 *
 ...
 */
abstract class Base_Places_Domain extends Db_Row
{
	/**
	 * @property $hostname
	 * @type {string}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Places', 'indexes', 'Domain', false)) {
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Places_Domain'))
		);
	}
