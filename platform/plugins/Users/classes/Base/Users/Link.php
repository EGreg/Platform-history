 ...
 * Instead, change the Users_Link.php file.
 *
 * @module Users
 */
/**
...
abstract class Base_Users_Link extends Db_Row
{
	...
	function beforeSet_identifier($value)
	{
		...
		if (strlen($value) > 255)
			throw new Exception('Exceedingly long value being assigned to '.$this->getTable().".identifier");
		return array('identifier', $value);			
	}
	...
	{
		$field_names = array('identifier', 'userId', 'extraInfo', 'insertedTime');
		$result = $field_names;
