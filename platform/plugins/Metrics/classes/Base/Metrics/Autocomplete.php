 ...
 * Instead, change the Metrics_Autocomplete.php file.
 *
 * @module Metrics
 */
/**
 * Base class representing 'Autocomplete' rows in the 'Metrics' database
 * @class Base_Metrics_Autocomplete
 * @extends Db_Row
 *
 ...
 */
abstract class Base_Metrics_Autocomplete extends Db_Row
{
	/**
	 * @property $query
	 * @type {string}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Metrics', 'indexes', 'Autocomplete', false)) {
	...
	static function select($fields, $alias = null)
	{
		...
		$q->className = 'Metrics_Autocomplete';
		return $q;
	}
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Metrics_Autocomplete'))
		);
	}
