 ...
 * Instead, change the Metrics/Autocomplete.js file.
 *
 * @module Metrics
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Metrics', 'indexes', 'Autocomplete'], false)) {
 ...
 * @type string
 */
Base.prototype.className = "Metrics_Autocomplete";
