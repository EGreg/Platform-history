 ...
 * Instead, change the Metrics/Session.js file.
 *
 * @module Metrics
 */
...
function Base (fields) {
	 ...
	 * @type string
	 */
	this.className = "Metrics_Session";
}
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Metrics', 'indexes', 'Session'], false)) {
