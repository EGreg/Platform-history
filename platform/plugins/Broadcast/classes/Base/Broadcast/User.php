 ...
 * Instead, change the Broadcast_User.php file.
 *
 * @module Broadcast
 */
/**
 * Base class representing 'User' rows in the 'Broadcast' database
 * @class Base_Broadcast_User
 * @extends Db_Row
 */
abstract class Base_Broadcast_User extends Db_Row
{
	/**
	...
	{
		if (Q_Config::get('Db', 'connections', 'Broadcast', 'indexes', 'User', false)) {
	 ...
	 * @method beforeSet_friend_count
	 * @param {integer} $value
	 * @return {array} An array of field name and value
	 * @throws {Exception} An exception is thrown if $value is not integer or does not fit in allowed range
	 */
	function beforeSet_friend_count($value)
	{
		if (!isset($value)) return array('friend_count', $value);
		if ($value instanceof Db_Expression) return array('friend_count', $value);
		if (!is_numeric($value) or floor($value) != $value)
			throw new Exception('Non-integer value being assigned to '.$this->getTable().".friend_count");
		if ($value < 0 or $value > 4294967295)
			throw new Exception("Out-of-range value '$value' being assigned to ".$this->getTable().".friend_count");
		return array('friend_count', $value);			
	}
	...
	{
		$field_names = array('userId', 'friend_count');
		$result = $field_names;
