 ...
 * Instead, change the Websites_Bio.php file.
 *
 * @module Websites
 */
/**
 * Base class representing 'Bio' rows in the 'Websites' database
 * @class Base_Websites_Bio
 * @extends Db_Row
 *
...
abstract class Base_Websites_Bio extends Db_Row
{
	...
	{
		if (Q_Config::get('Db', 'connections', 'Websites', 'indexes', 'Bio', false)) {
			return new Db_Expression(($with_db_name ? '{$dbname}.' : '').'{$prefix}'.'bio');
		} else {
			$conn = Db::getConnection('Websites');
  			$prefix = empty($conn['prefix']) ? '' : $conn['prefix'];
  			$table_name = $prefix . 'bio';
  			if (!$with_db_name)
  				return $table_name;
