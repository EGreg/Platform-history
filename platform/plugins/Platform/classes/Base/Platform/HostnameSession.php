 ...
 * Instead, change the Platform_HostnameSession.php file.
 *
 * @module Platform
 */
/**
 * Base class representing 'HostnameSession' rows in the 'Platform' database
 * @class Base_Platform_HostnameSession
 * @extends Db_Row
 *
 * @property {string} $hostname
 * @property {string} $sessionId
 */
abstract class Base_Platform_HostnameSession extends Db_Row
{
	/**
	 * @property $hostname
	 * @type {string}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Platform', 'indexes', 'HostnameSession', false)) {
	...
	static function select($fields, $alias = null)
	{
		...
		$q->className = 'Platform_HostnameSession';
		return $q;
	}
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Platform_HostnameSession'))
		);
	}
