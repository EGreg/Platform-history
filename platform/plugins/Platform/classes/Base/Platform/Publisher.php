 ...
 * Instead, change the Platform_Publisher.php file.
 *
 * @module Platform
 */
/**
 * Base class representing 'Publisher' rows in the 'Platform' database
 * @class Base_Platform_Publisher
 * @extends Db_Row
 *
 * @property {integer} $id
 ...
 */
abstract class Base_Platform_Publisher extends Db_Row
{
	/**
	 * @property $id
	 * @type {integer}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Platform', 'indexes', 'Publisher', false)) {
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Platform_Publisher'))
		);
	}
