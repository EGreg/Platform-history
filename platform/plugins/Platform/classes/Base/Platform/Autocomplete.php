 ...
 * Instead, change the Platform_Autocomplete.php file.
 *
 * @module Platform
 */
/**
 * Base class representing 'Autocomplete' rows in the 'Platform' database
 * @class Base_Platform_Autocomplete
 * @extends Db_Row
 *
 ...
 */
abstract class Base_Platform_Autocomplete extends Db_Row
{
	/**
	 * @property $query
	 * @type {string}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Platform', 'indexes', 'Autocomplete', false)) {
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Platform_Autocomplete'))
		);
	}
