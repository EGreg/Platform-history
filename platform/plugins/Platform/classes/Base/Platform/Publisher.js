 ...
 * Instead, change the Platform/Publisher.js file.
 *
 * @module Platform
 */
...
/**
 * Base class representing 'Publisher' rows in the 'Platform' database
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Platform', 'indexes', 'Publisher'], false)) {
...
Base.SELECT = function(fields, alias) {
	...
	q.className = 'Platform_Publisher';
	return q;
};
 ...
 * @type string
 */
Base.prototype.className = "Platform_Publisher";
...
Base.prototype.beforeSet_session_name = function (value) {
	 ...
	 * @return {integer}
	 */
Base.prototype.maxSize_session_name = function () {
