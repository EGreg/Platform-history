 ...
 * Instead, change the Platform_Visit.php file.
 *
 * @module Platform
 */
/**
 * Base class representing 'Visit' rows in the 'Platform' database
 * @class Base_Platform_Visit
 * @extends Db_Row
 *
 * @property {string} $id
 ...
 */
abstract class Base_Platform_Visit extends Db_Row
{
	/**
	 * @property $id
	 * @type {string}
	...
	{
		if (Q_Config::get('Db', 'connections', 'Platform', 'indexes', 'Visit', false)) {
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Platform_Visit'))
		);
	}
