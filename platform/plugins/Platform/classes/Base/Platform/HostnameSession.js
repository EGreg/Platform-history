 ...
 * Instead, change the Platform/HostnameSession.js file.
 *
 * @module Platform
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Platform', 'indexes', 'HostnameSession'], false)) {
 ...
 * @type string
 */
Base.prototype.className = "Platform_HostnameSession";
