 ...
 * Instead, change the Platform_Zipcode.php file.
 *
 * @module Platform
 */
/**
 * Base class representing 'Zipcode' rows in the 'Platform' database
 * @class Base_Platform_Zipcode
 * @extends Db_Row
 *
 ...
 */
abstract class Base_Platform_Zipcode extends Db_Row
{
	/**
	...
	{
		if (Q_Config::get('Db', 'connections', 'Platform', 'indexes', 'Zipcode', false)) {
	...
	static function insertManyAndExecute($records = array(), $options = array())
	{
		self::db()->insertManyAndExecute(
			self::table(), $records,
			array_merge($options, array('className' => 'Platform_Zipcode'))
		);
	}
