...
function Streams_Stream (fields) {
	 ...
	 *	Callback receives "error" and "result" as arguments
	 */
	this.incParticipants = function (callback) {
	 ...
	 *	Callback receives "error" and "result" as arguments
	 */
	this.decParticipants = function (callback) {
		updateField.call(this, 'participantCount', "participantCount - 1", callback);
	};
	 ...
	 *	Callback receives "error" and "result" as arguments
	 */
	this.incMessages = function (callback) {
	 ...
	 */
	this.messageParticipants = function (event, uid, msg) {
	 ...
	 */
	this.calculateAccess = function(asUserId, callback) {
	 ...
	 */
	this.inheritAccess = function (callback) {
		if (!callback) return;
		var subj = this;
	...
	this.leave = function(options, callback) {
	...
	this.unsubscribe = function(options, callback) {
		// TODO: Nazar: Implement to be similar to PHP, and add documentation
		callback(); // pass err
	};
