 ...
 *	 "scrollbarPadding": Defaults to true. Boolean which indicates whether to preserve padding in a container based on scrollbar
 *											 width. Padding preserved on the right side (for vertical scrolling) or on the bottom side
 *											 (for horizontal scrolling).
 *	 "showHandler": Optional. Q.Event callback which is called when scrollbar is just shown.
 *	 "showHandler": Optional. Q.Event callback which is called when scrollbar is just hidden.
 *	 
